...
const Card = ({ children, className = '' }) => (
  <div className={`relative group ${className}`}>
    <div className="absolute -inset-0.5 bg-gradient-to-r from-[#06b6d4] to-[#10b981] rounded-2xl blur opacity-10 group-hover:opacity-25 transition duration-500" />
...
const SkeletonCard = () => (
  <div className="relative">
    <div className="absolute -inset-0.5 bg-gradient-to-r from-[#06b6d4] to-[#10b981] rounded-2xl blur opacity-10" />
...
const CertCard = ({ cert, onDelete }) => {
  ...
  return (
    <div className="relative group">
      <div className="absolute -inset-0.5 bg-gradient-to-r from-[#06b6d4] to-[#10b981] rounded-2xl blur opacity-10 group-hover:opacity-30 transition duration-500" />
      <div className="relative bg-white/5 border border-white/12 rounded-2xl overflow-hidden">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        <div className="relative">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-[#06b6d4] to-[#10b981] rounded-xl blur opacity-50" />
